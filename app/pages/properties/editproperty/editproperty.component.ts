            ...
            this.propertyService.getPropertyById(params['id']).subscribe(
                d => {
                    ...
                    this.propertyForm = this.builder.group({
                        ...
                        BoxUrl: [d.BoxUrl, Validators.pattern('^((https?|ftp)://)?([a-z]+[.])?[a-z0-9-]+([.][a-z]{1,4}){1,2}(/.*[?].*)?$')],
                        AgencyPackUrl: [d.AgencyPackUrl, Validators.pattern('^((https?|ftp)://)?([a-z]+[.])?[a-z0-9-]+([.][a-z]{1,4}){1,2}(/.*[?].*)?$')],
                        MinimumStay: [d.MinimumStay, Validators.required],
