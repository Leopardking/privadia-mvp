        ...
        this.sub = this.route.params.subscribe(function (params) {
            _this.propertyService.getPropertyById(params['id']).subscribe(function (d) {
                ...
                _this.propertyForm = _this.builder.group({
                    ...
                    BoxUrl: [d.BoxUrl, forms_1.Validators.pattern('^((https?|ftp)://)?([a-z]+[.])?[a-z0-9-]+([.][a-z]{1,4}){1,2}(/.*[?].*)?$')],
                    AgencyPackUrl: [d.AgencyPackUrl, forms_1.Validators.pattern('^((https?|ftp)://)?([a-z]+[.])?[a-z0-9-]+([.][a-z]{1,4}){1,2}(/.*[?].*)?$')],
                    MinimumStay: [d.MinimumStay, forms_1.Validators.required],
