import {
	Component, OnInit, Input, AfterContentChecked, AfterContentInit, AfterViewChecked,
	AfterViewInit
} from '@angular/core';
...
export class CalendarComponent implements OnInit, AfterContentChecked, AfterContentInit, AfterViewChecked, AfterViewInit {
	...
	ngAfterContentChecked() {
		console.log('Test calendar ngAfterContentChecked', this.bookingDays);
	}

	ngAfterContentInit() {
		console.log('Test calendar ngAfterContentInit', this.bookingDays);
	}

	ngAfterViewChecked() {
		console.log('Test calendar ngAfterViewChecked', this.bookingDays);
	}

	ngAfterViewInit() {
		console.log('Test calendar ngAfterViewInit', this.bookingDays);
	}
	...
	public isBetweens(date) {
		console.log('isBetweens', date.format('MM/DD/YYYY'));
		let day = {
			type: <string> null,
			typeStart: <string> null,
			typeEnd: <string> null,
